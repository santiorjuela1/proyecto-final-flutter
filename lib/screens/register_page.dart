...
class RegisterPage extends StatefulWidget {
  ...
  const RegisterPage({Key? key, required this.showLoginPage, required Null Function() showRegisterPage}) : super(key: key);
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> signUp() async {
    ...
    Usuario nuevoUsuario =
        Usuario(correoElectronico: correo, contrasena: contrasena);

    // Verificar las credenciales
    if (nuevoUsuario.verificarCredenciales(correo, contrasena)) {
